...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
                                    ...
                                    <tbody>
                                        <?php if (!empty($residents)): ?>
                                            <?php foreach ($residents as $row): ?>
                                                <tr data-id="<?php echo htmlspecialchars($row['resident_id']); ?>">
                                                    ...
                                                    <td>
                                                        <button class="btn btn-sm btn-warning me-1 edit-resident-btn" data-bs-toggle="modal" data-bs-target="#updateResidentModal">
                                                            <i class="fas fa-edit"></i> Edit
                                                        </button>
                                                        <button class="btn btn-sm btn-danger delete-resident-btn" data-bs-toggle="modal" data-bs-target="#deleteResidentModal">
        ...
        <!-- Create / Update / Delete Modals for Residents -->
                    ...
                    <form id="createResidentForm">
                        <div class="modal-body">
                            <div class="mb-3">
                                ...
                                <input type="text" id="resident_id" name="resident_id" class="form-control" placeholder="R000000001"> 
                                <div class="form-text small text-muted">Optional: leave blank to auto-generate.</div>
                            </div>
                            <div class="mb-3">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form id="updateResidentForm">
                        <div class="modal-body">
                            <input type="hidden" id="update_resident_id" name="resident_id">
                            <div class="mb-3">
                                <label class="form-label">Resident ID</label>
                                <input type="text" id="edit_resident_id_display" class="form-control" disabled>
                            </div>
                            <div class="mb-3">
                                <label class="form-label">First Name</label>
                            ...
                            <div class="mb-3">
                                <label class="form-label">Gender</label>
                                <select id="update_gender" name="gender" class="form-select" required>
                                    <option value="Male">Male</option>
                                    <option value="Female">Female</option>
                                    <option value="Other">Other</option>
                                </select>
                            ...
                            <div class="mb-3">
                                <label class="form-label">Civil Status</label>
                                <select id="update_civil_status" name="civil_status" class="form-select" required>
                                    <option value="Single">Single</option>
                                    <option value="Married">Married</option>
                                    <option value="Widowed">Widowed</option>
                                    <option value="Separated">Separated</option>
                            ...
                            <div class="mb-3">
                                <label class="form-label">Contact No.</label>
                                <input type="text" id="update_contact_no" name="contact_no" class="form-control">
                            </div>
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
        ...
        <script>
            ...
            document.getElementById('createResidentForm').addEventListener('submit', async function(e) {
                ...
                const data = {
                    resident_id: document.getElementById('resident_id').value.trim(),
            ...
            document.addEventListener('click', async function(e){
                const editBtn = e.target.closest('.edit-resident-btn');
                if (!editBtn) return;
                ...
                try {
                    ...
                    if (result.success && result.data) {
                        const d = result.data;
                        document.getElementById('update_resident_id').value = d.resident_id || id;
                        document.getElementById('edit_resident_id_display').value = d.resident_id || id;
                        ...
                        document.getElementById('update_birthdate').value = d.birthdate || '';
                        document.getElementById('update_gender').value = d.gender || 'Male';
                        document.getElementById('update_civil_status').value = d.civil_status || 'Single';
                        document.getElementById('update_contact_no').value = d.contact_no || '';
                    } else {
            ...
            document.getElementById('updateResidentForm').addEventListener('submit', async function(e){
                e.preventDefault();
                const data = {
                    resident_id: document.getElementById('update_resident_id').value,
                    ...
                    birthdate: document.getElementById('update_birthdate').value,
                    gender: document.getElementById('update_gender').value,
                    civil_status: document.getElementById('update_civil_status').value,
            ...
            document.addEventListener('click', function(e){
                const delBtn = e.target.closest('.delete-resident-btn');
                if (!delBtn) return;
            ...
            document.getElementById('deleteResidentForm').addEventListener('submit', async function(e){
                e.preventDefault();
                const resident_id = document.getElementById('delete_resident_id').value;
                ...
                try {
                    const res = await fetch(API_URL + '?action=delete', { method: 'POST', headers: {'Content-Type':'application/json'}, body: JSON.stringify({resident_id}) });
                    const result = await res.json();
                    if (result.success) {
